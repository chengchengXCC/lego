...
public interface MyConstants {
	...
	public static final String ANDROID_SUPPORT_V4 = "android-support-v4.jar";
	public static final String GOOGLE_PLAY_SERVICES = "google-play-services.jar";
	public static final String SNAPPY_JAVA = "snappy-java.1.1.1.7.jar";
	
	//public static final String ANDROID = "android.jar";
	//public static final String ANDROID_14 = "android-14.jar";
	
	public static final String ANDROID_21 = "android-.jar";//4.4
	public static final String ANDROID_20 = "android-20.jar";//4.4
	...
	public static final String GOOGLE_MAPS_21 = "maps-21.jar";
	...
	*/
	...
	public static boolean TO_TAINT_THIS_OBJECT = true;
